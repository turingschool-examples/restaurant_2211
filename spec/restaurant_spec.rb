...
RSpec.describe Restaurant do
  ...
  describe '#open_for_lunch?' do 
    it 'is open for lunch if its opening time is before 12:00' do 
  ...
  describe '#menu_dish_names' do 
    it 'returns the array of dishes in all caps' do 
      restaurant1 = Restaurant.new('10:00', 'Fuel Cafe') 
      restaurant2 = Restaurant.new('16:00', 'Il Posto')  
  ...
  describe '#announce_closing_time' do 
    it 'changes format to 12 hour and returns string with closing time' do 
      restaurant1 = Restaurant.new('10:00', 'Fuel Cafe') 
      restaurant2 = Restaurant.new('16:00', 'Il Posto') 
